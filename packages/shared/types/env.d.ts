...
declare namespace NodeJS {
  interface ProcessEnv {
    readonly NODE_ENV: 'development' | 'production' | 'test' | 'uat';
  }
  interface Process {
...
declare function zE<T>(a?: T, b?: T, c?: T);

declare function twq(type: 'event', eventName: string, opts?: { email_address?: string; phone_number?: string });
declare function fbq(type: 'track', event: 'CompleteRegistration');
