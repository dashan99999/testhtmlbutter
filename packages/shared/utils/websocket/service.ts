...
// Observable;
// const { status, data, send, open, close } = useWebSocket('wss://websocketurl');

// export class WebsocketService {
//   private $message: Subject<any>;
//   private connection: UseWebSocketReturn<any>; // ws 连接对象

//   isConnected = false; // 是否已经连接
...
//     this.connection = useWebSocket('ws://websocketurl');
//   }
...
//   /**
//    * @description 初始化需监听的类型 channel
//    */
//   initChannelType(prama?, callback?): Promise<any> {
//     return this.connection
//       .invoke('SendMessage', prama)
